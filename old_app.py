...
# Keep only the important demo controls visible in the sidebar.
...
# Use automatically detected columns behind the scenes.
# These are not shown in the sidebar because they are implementation details for the demo.
species_col = species_guess
native_col = native_guess
diameter_bin_col = diameter_guess
lat_col = lat_guess
lon_col = lon_guess
